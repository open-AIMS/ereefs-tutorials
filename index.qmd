...
::::{.hp-tutorial}
:::{.hp-thumbnail}
![](images/tutorial-thumbnails/TN_download_icon.png)
:::
:::{.hp-text}
...
:::
:::{.hp-text}
[Setup Jupyter Notebook]{.hp-title}<br>
Setup *Python* and *Jupyter Notebook* on your development environment, to run the Python tutorials found in
this website.
:::
:::{.hp-links}
[{{< fa solid book >}} Start](tutorials/python/follow-along/python_and_jupyter_setup.qmd)
:::
::::
...
Learn the basics of extracting aggregated eReefs data from the AIMS server using the efficient OPeNDAP data
access protocol.
:::
:::{.hp-links}
...
data from the AIMS server for multiple dates and points.
:::
:::{.hp-links}
