...
In this tutorial we will look at how to access eReefs data directly from the [AIMS THREDDS server](https://thredds.ereefs.aims.gov.au/thredds/catalog/catalog.html) in R. 
