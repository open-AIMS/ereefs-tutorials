...
The points can be added using the `Add placemark` tool (looks like a pin). The locations can be seen by displaying the placemark properties. The resulting KML file can be found here: [extraction-tool-locations.kml](resources/extraction-tool-locations.kml).
