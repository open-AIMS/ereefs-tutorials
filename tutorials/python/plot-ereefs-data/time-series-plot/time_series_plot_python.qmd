...
[AIMS eReefs THREDDS catalogue](https://thredds.ereefs.aims.gov.au/thredds/catalog/ereefs/gbr4_v4/catalog.html).
...
```{python}
# OPeNDAP URL to file "EREEFS_AIMS-CSIRO_gbr4_v4_hydro_daily-monthly-YYYY-MM.nc". Hydrodynamic 4km model, daily data for the month specified
inputFile = "https://thredds.ereefs.aims.gov.au/thredds/dodsC/ereefs/gbr4_v4/daily-monthly/EREEFS_AIMS-CSIRO_gbr4_v4_hydro_daily-monthly-"+netCDF_datestr+".nc"
