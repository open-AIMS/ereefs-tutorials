...
with depth. With v4.0 of the hydrodynamic model and the matching v3.2
...
#### Raw FX3 models (GBR1 v2.0 & GBR4 v4.0)

| k (GBR1 v2.0) | Depth (m) | k (GBR4 v4.0) | Depth (m) |
|-------------:|-----------:|-------------:|-----------:|
| 0            |  -3885.0   | 0            |  -3890.0  |
| 1            |  -3660.0   | 1            |  -3680.0  |
| 2            |  -3430.0   | 2            |  -3480.0  |
...
#### Regridded aggregate models (GBR1 v2.0 & GBR4 v4.0)
...
* [The CSIRO Environmental Modelling Suite (EMS) documentation](https://research.csiro.au/cem/software/ems/ems-documentation/)
